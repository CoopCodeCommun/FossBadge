# Generated by Django 6.0.2 on 2026-03-09 14:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(blank=True, choices=[('beginner', 'Débutant'), ('intermediate', 'Intermédiaire'), ('expert', 'Expert')], max_length=20, null=True, verbose_name='Niveau')),
                ('description', models.TextField(verbose_name='Description')),
                ('is_dream_badge', models.BooleanField(default=False, verbose_name='Badge de rêve')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Date de création')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='issued_badges', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
                'verbose_name': 'Badge',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admins', models.ManyToManyField(related_name='structures_admins', to=settings.AUTH_USER_MODEL, verbose_name='Administrateurs')),
                ('editors', models.ManyToManyField(related_name='structures_editors', to=settings.AUTH_USER_MODEL, verbose_name='Éditeurs')),
                ('marker', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='structures', to='mapview.marker')),
                ('users', models.ManyToManyField(blank=True, related_name='structures_users', to=settings.AUTH_USER_MODEL, verbose_name='Utilisateurs')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='core.badge', verbose_name='Badge')),
                ('user', models.OneToOneField(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dream_course', to=settings.AUTH_USER_MODEL, verbose_name='User')),
                ('structure', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='core.structure', verbose_name='Structure')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('structure', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='endorsements', to='core.structure', verbose_name='Structure')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_structure', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assigned_badges', to='core.structure', verbose_name='Assigné par')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parents', models.ManyToManyField(blank=True, related_name='children', to='core.courseitem', verbose_name='Parent')),
            ],
            options={
