...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        kml_path = os.path.join(
            settings.BASE_DIR,
            "mapview/fixtures/Université Populaire de Villeurbanne.kml",
        )
    ...
    def create_users(self):
        ...
        user_data = [
            ...
            {
                "username": "pierre.martin@example.com",
                "first_name": "Pierre",
                "last_name": "Martin",
            ...
            {
                "username": "sophie.lefebvre@example.com",
                "first_name": "Sophie",
                "last_name": "Lefebvre",
            ...
            {
                "username": "lucas.bernard@example.com",
                "first_name": "Lucas",
                "last_name": "Bernard",
            ...
            {
                "username": "thomas.doug@example.com",
                "first_name": "Thomas",
                "last_name": "Doug",
            ...
            {
                "username": "julie.moreau@example.com",
                "first_name": "Julie",
                "last_name": "Moreau",
            ...
            {
                "username": "nicolas.girard@example.com",
                "first_name": "Nicolas",
                "last_name": "Girard",
            ...
            {
                "username": "emilie.rousseau@example.com",
                "first_name": "Émilie",
                "last_name": "Rousseau",
            ...
            {
                "username": "antoine.mercier@example.com",
                "first_name": "Antoine",
                "last_name": "Mercier",
            ...
            {
                "username": "isabelle.blanc@example.com",
                "first_name": "Isabelle",
                "last_name": "Blanc",
            ...
            {
                "username": "marc.leroy@example.com",
                "first_name": "Marc",
                "last_name": "Leroy",
            ...
            {
                "username": "claire.dubois@example.com",
                "first_name": "Claire",
                "last_name": "Dubois",
            ...
            {
                "username": "alexandre.fournier@example.com",
        ...
        for data in user_data:
            ...
            if (
                self.profile_images
                and (created or not user.avatar)
                and self.load_images
            ):
                # Get a random image from the available profile images
                image_path = random.choice(self.profile_images)
                with open(image_path, "rb") as f:
                    user.avatar.save(os.path.basename(image_path), File(f), save=True)
                self.stdout.write(
                    f"Added avatar {os.path.basename(image_path)} to {user.username}"
                )
    ...
    def create_structures(self):
        ...
        for data in structure_data:
            ...
            if data["name"] == "KILT (Low Tech)":
                lookup_name = "KILT"
            # Special case for Université Populaire
            if data["name"] == "Université Populaire":
                lookup_name = "Université Populaire de Villeurbanne"
            ...
            if (created or not structure.logo) and self.load_images:
                if self.structure_images:
                    ...
                    with open(image_path, "rb") as f:
                        structure.logo.save(
                            os.path.basename(image_path), File(f), save=True
                        )
                    self.stdout.write(
                        f"Added logo {os.path.basename(image_path)} to {structure.name}"
                    )
        ...
        for data in badge_data:
            ...
            if (created or not badge.icon) and self.load_images:
                if self.badge_images:
                    ...
                    self.stdout.write(
                        f"Added icon {os.path.basename(image_path)} to {badge.name}"
                    )
            ...
            structure_notes = assignment_notes_by_theme.get(
                data["issuing_structure"], []
            )
            ...
            for user in holders:
                ...
                assigner = (
                    random.choice(possible_assigners)
                    if possible_assigners and random.random() > 0.2
                    else None
                )
                ...
                note = (
                    random.choice(structure_notes)
                    if structure_notes
                    else "Compétence validée lors d'un atelier pratique."
                )
            ...
            endorsing_structures = (
                random.sample(other_structures, endorsing_count)
                if endorsing_count > 0
                else []
            )
            ...
            for structure in endorsing_structures:
                ...
                endorsement, e_created = BadgeEndorsement.objects.get_or_create(
                    ...
                    structure=structure,
                    defaults={
                        "endorsed_by": random.choice(users)
    ...
    def create_badge_criteria(self, badges, structures):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Created {criteria_created_count} badge criteria")
        )
    ...
    def create_demo_admin(self, structures):
        ...
        thomas, created = User.objects.get_or_create(
            username="thomas@codecommun.coop",
            defaults={
                "first_name": "Thomas",
                "last_name": "Admin",
        ...
        if created:
            ...
            thomas.save()
            self.stdout.write(
                self.style.SUCCESS("Created demo admin: thomas / labrique")
            )
        else:
        ...
        self.stdout.write(
            self.style.SUCCESS(f"thomas is admin of {len(structures)} structures")
        )
